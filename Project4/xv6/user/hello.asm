...
int main(int argc, char *argv[])
{
  ...
  1e:	27e080e7          	jalr	638(ra) # 298 <exit>
...
memset(void *dst, int c, uint n)
{
  ...
  int i;
  for(i = 0; i < n; i++){
  9a:	ce09                	beqz	a2,b4 <memset+0x20>
  9c:	87aa                	mv	a5,a0
  9e:	fff6071b          	addiw	a4,a2,-1
  a2:	1702                	slli	a4,a4,0x20
  a4:	9301                	srli	a4,a4,0x20
  a6:	0705                	addi	a4,a4,1
  a8:	972a                	add	a4,a4,a0
    cdst[i] = c;
  aa:	00b78023          	sb	a1,0(a5)
  for(i = 0; i < n; i++){
  ae:	0785                	addi	a5,a5,1
  b0:	fee79de3          	bne	a5,a4,aa <memset+0x16>
  }
  return dst;
}
  b4:	6422                	ld	s0,8(sp)
...
gets(char *buf, int max)
{
 ...
 104:	0344d863          	bge	s1,s4,134 <gets+0x56>
    cc = read(0, &c, 1);
 108:	4605                	li	a2,1
 10a:	faf40593          	addi	a1,s0,-81
 10e:	4501                	li	a0,0
 110:	00000097          	auipc	ra,0x0
 114:	1a0080e7          	jalr	416(ra) # 2b0 <read>
    if(cc < 1)
 118:	00a05e63          	blez	a0,134 <gets+0x56>
    buf[i++] = c;
 11c:	faf44783          	lbu	a5,-81(s0)
 120:	00f90023          	sb	a5,0(s2)
    if(c == '\n' || c == '\r')
 124:	01578763          	beq	a5,s5,132 <gets+0x54>
 128:	0905                	addi	s2,s2,1
 12a:	fd679be3          	bne	a5,s6,100 <gets+0x22>
  for(i=0; i+1 < max; ){
 12e:	89a6                	mv	s3,s1
 130:	a011                	j	134 <gets+0x56>
 132:	89a6                	mv	s3,s1
      break;
  }
  buf[i] = '\0';
...
stat(const char *n, struct stat *st)
{
 ...
 166:	176080e7          	jalr	374(ra) # 2d8 <open>
  if(fd < 0)
 16a:	02054563          	bltz	a0,194 <stat+0x42>
 16e:	84aa                	mv	s1,a0
    return -1;
  r = fstat(fd, st);
 170:	85ca                	mv	a1,s2
 172:	00000097          	auipc	ra,0x0
 176:	17e080e7          	jalr	382(ra) # 2f0 <fstat>
 17a:	892a                	mv	s2,a0
  close(fd);
 17c:	8526                	mv	a0,s1
 17e:	00000097          	auipc	ra,0x0
 182:	142080e7          	jalr	322(ra) # 2c0 <close>
  return r;
}
 186:	854a                	mv	a0,s2
...
memmove(void *vdst, const void *vsrc, int n)
{
 ...
 1e6:	0800                	addi	s0,sp,16
  ...
  src = vsrc;
  if (src > dst) {
 1e8:	02b57663          	bgeu	a0,a1,214 <memmove+0x32>
    while(n-- > 0)
 ...
 234:	00d70023          	sb	a3,0(a4)
    while(n-- > 0)
 238:	fee79ae3          	bne	a5,a4,22c <memmove+0x4a>
...
memcpy(void *dst, const void *src, uint n)
{
 ...
 284:	f62080e7          	jalr	-158(ra) # 1e2 <memmove>
}
 288:	60a2                	ld	ra,8(sp)
 28a:	6402                	ld	s0,0(sp)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 390:	47450513          	addi	a0,a0,1140 # 800 <digits>
 394:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 45c:	3a8b8b93          	addi	s7,s7,936 # 800 <digits>
 ...
 59c:	26090913          	addi	s2,s2,608 # 7f8 <malloc+0x11a>
        while(*s != 0){
...
free(void *ap)
{
 ...
 664:	1b87b783          	ld	a5,440(a5) # 818 <freep>
 ...
 692:	00e6ea63          	bltu	a3,a4,6a6 <free+0x50>
{
 ...
 6d4:	14f73423          	sd	a5,328(a4) # 818 <freep>
}
 6d8:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 706:	11653503          	ld	a0,278(a0) # 818 <freep>
 ...
 72e:	0ee90913          	addi	s2,s2,238 # 818 <freep>
  if(p == (char*)-1)
 732:	5afd                	li	s5,-1
 734:	a88d                	j	7a6 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 736:	00000797          	auipc	a5,0x0
 73a:	0ea78793          	addi	a5,a5,234 # 820 <base>
 73e:	00000717          	auipc	a4,0x0
 742:	0cf73d23          	sd	a5,218(a4) # 818 <freep>
 746:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 768:	0aa73a23          	sd	a0,180(a4) # 818 <freep>
      return (void*)(p + 1);
