...
00000000000011b2 <copyinstr2>:
{
  ...
  if(pid == 0){
    ...
    124a:	22a78793          	addi	a5,a5,554 # 8470 <big.1268>
...
0000000000002188 <bigargtest>:
{
  ...
  close(fd);
    ...
    21f0:	18478793          	addi	a5,a5,388 # 8370 <args.1848>
    21f4:	00006697          	auipc	a3,0x6
    21f8:	27468693          	addi	a3,a3,628 # 8468 <args.1848+0xf8>
    ...
    2210:	16458593          	addi	a1,a1,356 # 8370 <args.1848>
