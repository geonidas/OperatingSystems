...
int main (int argc, char *argv[])
{
  ...
  16:	3f2080e7          	jalr	1010(ra) # 404 <uptime>
  1a:	892a                	mv	s2,a0
	int process = fork();
  1c:	00000097          	auipc	ra,0x0
  20:	348080e7          	jalr	840(ra) # 364 <fork>
  ...
  24:	02054b63          	bltz	a0,5a <main+0x5a>
	...
	if (process > 0)
  28:	04a04763          	bgtz	a0,76 <main+0x76>
		wait(0);
	if (process == 0) 
	{
  ...
  36:	372080e7          	jalr	882(ra) # 3a4 <exec>
  3a:	04055363          	bgez	a0,80 <main+0x80>
		{
			printf("error: Exec error\n", 2);
  3e:	4589                	li	a1,2
  40:	00001517          	auipc	a0,0x1
  44:	86850513          	addi	a0,a0,-1944 # 8a8 <malloc+0xfe>
  48:	00000097          	auipc	ra,0x0
  4c:	6a4080e7          	jalr	1700(ra) # 6ec <printf>
			exit(0);
  50:	4501                	li	a0,0
  52:	00000097          	auipc	ra,0x0
  56:	31a080e7          	jalr	794(ra) # 36c <exit>
		printf("error: invalid process\n", 2);
  5a:	4589                	li	a1,2
  5c:	00001517          	auipc	a0,0x1
  60:	83450513          	addi	a0,a0,-1996 # 890 <malloc+0xe6>
  64:	00000097          	auipc	ra,0x0
  68:	688080e7          	jalr	1672(ra) # 6ec <printf>
		exit(0);
  6c:	4501                	li	a0,0
  6e:	00000097          	auipc	ra,0x0
  72:	2fe080e7          	jalr	766(ra) # 36c <exit>
		wait(0);
  76:	4501                	li	a0,0
  78:	00000097          	auipc	ra,0x0
  7c:	2fc080e7          	jalr	764(ra) # 374 <wait>
		}
	}
	
	int endtime = uptime();
  80:	00000097          	auipc	ra,0x0
  84:	384080e7          	jalr	900(ra) # 404 <uptime>
	int secs = (endtime - current)/100;
  88:	4125093b          	subw	s2,a0,s2
	int part = (endtime - current)%100;
  8c:	06400a13          	li	s4,100
  90:	034969bb          	remw	s3,s2,s4
	  
	printf("%s", argv[1], 1);
  94:	4605                	li	a2,1
  96:	648c                	ld	a1,8(s1)
  98:	00001517          	auipc	a0,0x1
  9c:	82850513          	addi	a0,a0,-2008 # 8c0 <malloc+0x116>
  a0:	00000097          	auipc	ra,0x0
  a4:	64c080e7          	jalr	1612(ra) # 6ec <printf>
	printf(" ran in %d.", secs, 1);
  a8:	4605                	li	a2,1
  aa:	034945bb          	divw	a1,s2,s4
  ae:	00001517          	auipc	a0,0x1
  b2:	81a50513          	addi	a0,a0,-2022 # 8c8 <malloc+0x11e>
  b6:	00000097          	auipc	ra,0x0
  ba:	636080e7          	jalr	1590(ra) # 6ec <printf>
	
	if (part < 10)
  be:	47a5                	li	a5,9
  c0:	0337d163          	bge	a5,s3,e2 <main+0xe2>
		printf("0", 1);
	printf("%d\n", part, 1);
  c4:	4605                	li	a2,1
  c6:	85ce                	mv	a1,s3
  c8:	00001517          	auipc	a0,0x1
  cc:	81850513          	addi	a0,a0,-2024 # 8e0 <malloc+0x136>
  d0:	00000097          	auipc	ra,0x0
  d4:	61c080e7          	jalr	1564(ra) # 6ec <printf>

	exit(0);
  d8:	4501                	li	a0,0
  da:	00000097          	auipc	ra,0x0
  de:	292080e7          	jalr	658(ra) # 36c <exit>
		printf("0", 1);
  e2:	4585                	li	a1,1
  e4:	00000517          	auipc	a0,0x0
  e8:	7f450513          	addi	a0,a0,2036 # 8d8 <malloc+0x12e>
  ec:	00000097          	auipc	ra,0x0
  f0:	600080e7          	jalr	1536(ra) # 6ec <printf>
  f4:	bfc1                	j	c4 <main+0xc4>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 45c:	49850513          	addi	a0,a0,1176 # 8f0 <digits>
 460:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 668:	28490913          	addi	s2,s2,644 # 8e8 <malloc+0x13e>
        while(*s != 0){
 ...
 75e:	00e6ea63          	bltu	a3,a4,772 <free+0x50>
{
 ...
 7a0:	16f73623          	sd	a5,364(a4) # 908 <freep>
}
 7a4:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7d2:	13a53503          	ld	a0,314(a0) # 908 <freep>
 ...
 7fa:	11290913          	addi	s2,s2,274 # 908 <freep>
  if(p == (char*)-1)
 7fe:	5afd                	li	s5,-1
 800:	a88d                	j	872 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 802:	00000797          	auipc	a5,0x0
 806:	10e78793          	addi	a5,a5,270 # 910 <base>
 80a:	00000717          	auipc	a4,0x0
 80e:	0ef73f23          	sd	a5,254(a4) # 908 <freep>
 812:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 834:	0ca73c23          	sd	a0,216(a4) # 908 <freep>
      return (void*)(p + 1);
